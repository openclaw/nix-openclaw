...
- Scope source dependency rebuilds to the gateway root project, avoiding unrelated runtime plugin lifecycle downloads while preserving build approvals (2026-09-10).
